...
.data
main__STR1:	.asciiz "A map is reversible if it is a 1-to-1 relation between a set and itself (at least, in this context of a substitution cipher).  These maps are *NOT* actually reversible, because lots of different characters map to the period character."
.text
...
main__MAP1:	.ascii "................"	# ASCII 0x0
		.ascii "................"	# ASCII 0x1
		.ascii "................"	# ASCII 0x2
		.ascii "9876543210......"	# ASCII 0x3 - numerals
		.ascii ".zyxwvutsrqponml"	# ASCII 0x4 - uppercase, part 1
		.ascii "kjihgfedcba....."	# ASCII 0x5 - uppercase, part 2
		.ascii ".ZYXWVUTSRQPONML"	# ASCII 0x6 - lowercase, part 1
		.ascii "KJIHGFEDCBA....."	# ASCII 0x7 - lowercase, part 2
		.asciiz ""       # null terminator, for debugging after the call

main__MAP2:	.ascii "................"	# ASCII 0x0
		.ascii "................"	# ASCII 0x1
		.ascii "................"	# ASCII 0x2
		.ascii "ABCDEFGHIJ......"	# ASCII 0x3 - numerals
		.ascii ".KLMNOPQRSTUVWXY"	# ASCII 0x4 - uppercase, part 1
		.ascii "Zabcdefghij....."	# ASCII 0x5 - uppercase, part 2
		.ascii ".klmnopqrstuvwxy"	# ASCII 0x6 - lowercase, part 1
		.ascii "z0123456789....."	# ASCII 0x7 - lowercase, part 2
		.asciiz ""       # null terminator, for debugging after the call
.text
...
.data
printSubstitutedString__MSG1:	.asciiz "pSS(dup) version 3: dup="
.text
